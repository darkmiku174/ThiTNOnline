# Lưu ý: T chuyển pakage backend ra root folder(folder ThiTNOnline), cần cài gì cho backend thì cài luôn ở thư mục đó rồi dùng bình thường, đừng cài trong folder backend
